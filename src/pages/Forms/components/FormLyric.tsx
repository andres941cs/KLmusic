...
import { getLyricsByName } from "@services/ApiData";
        ...
        <Card className="p-5">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-3">
                ...
                <div className="flex gap-3">
                    ...
                    className="w-full border rounded py-1 px-2 bg-muted placeholder:text-xs placeholder:sm:text-base" 
                    type="text" placeholder="Name Song - Name Artist"/>
                ...
                <div className="flex gap-3">
                    <Label htmlFor="instrumental">Intrumental:</Label>
                    <input id="instrumental" onChange={(e)=>setInstrumental(e.target.checked)} type="checkbox" />
                </div>
