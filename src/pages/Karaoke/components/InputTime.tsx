...
function InputTime() {
    ...
    return ( 
        <input value={time} onChange={handleInputChange} autoComplete="off" type="text" pattern="[0-5][0-9]:[0-5][0-9]" className="h-full w-full bg-transparent" maxLength={7} aria-label=" 1&nbsp;minuto 1&nbsp;segundo 0 fotogramas"/>
     );
}
