...
export const VisibilityIcon= ({ size= 24,fill="#e8eaed",className="",onClick}:IconProps) => {
    return (
...
export const VisibilityOffIcon= ({ size= 24,fill="#e8eaed",className="",onClick}:IconProps) => {
    return (
        <svg width={size} height={size} fill={fill} className={className} onClick={onClick} viewBox="0 -960 960 960">
